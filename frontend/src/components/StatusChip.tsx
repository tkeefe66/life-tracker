 ...
 * `social? Yes/No`, `Removed · Undo`. This set does not grow casually — a
 * new scoring signal earns its own chip only as a deliberate design event,
 * the same weight as adding a category or a chart color.
 *
